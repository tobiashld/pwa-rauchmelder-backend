...
function getActiveWithHistoryId(
	request: any,
	response: any,
	historyId: number
) {
...
async function getAllWithObjectId(
	request: any,
	response: any,
	objektId: number
) {
...
async function changeRauchmelder(
	request: any,
	response: any,
	rauchmelderid: any
) {
...
async function getWithHistoryId(
	request: any,
	response: any,
	rauchmelderhistorienid: any
) {
	db.prisma.rauchmelderhistorie
		.findMany({
			where: {
...
async function deleteRauchmelder(
	request: any,
	response: any,
